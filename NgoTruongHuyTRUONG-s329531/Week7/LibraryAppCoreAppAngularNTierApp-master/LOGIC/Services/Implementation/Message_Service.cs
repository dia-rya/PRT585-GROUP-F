...
namespace LOGIC.Services.Implementation
{
    ...
    public class Message_Service : IMessage_Service
    {
        ...
        /// <returns></returns>
        public async Task<Generic_ResultSet<Message_ResultSet>> AddMessage(string name)
        {
            Generic_ResultSet<Message_ResultSet> result = new Generic_ResultSet<Message_ResultSet>();
            try
            {
                ...
                //SET SUCCESSFUL RESULT VALUES
                result.userMessage = string.Format("The supplied Message message {0} was added successfully", name);
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        public async Task<Generic_ResultSet<Message_ResultSet>> UpdateMessage(Int64 message_id, string name)
        {
            Generic_ResultSet<Message_ResultSet> result = new Generic_ResultSet<Message_ResultSet>();
            try
            {
                ...
                //SET SUCCESSFUL RESULT VALUES
                result.userMessage = string.Format("The supplied Message message {0} was updated successfully", name);
