...
{
    /// <summary>
    /// This service allows us to Add, Fetch and Update Message message Data
    /// </summary>
    public class Message_Service : IMessage_Service
    {
            ...
            try
            {
                ...
                Messagees.ForEach(s =>
                {
                    result.result_set.Add(new Message_ResultSet
                    {
                        ...
                        message_creation_date = s.Message_Creation_Date,
                        message_sent_date = s.Message_Sent_Date,
                        message_modified_date = s.Message_Modified_Date
        ...
        /// <returns></returns>
        public async Task<Generic_ResultSet<Message_ResultSet>> AddMessage(string content, string status, string creationDate, string sentDate, string modifiedDate)
        {
            Generic_ResultSet<Message_ResultSet> result = new Generic_ResultSet<Message_ResultSet>();
            try
            {
                ...
                Message Message = new Message
                {
                    ...
                    Message_Creation_Date = creationDate,
                    Message_Sent_Date = sentDate,
                    Message_Modified_Date = modifiedDate
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        public async Task<Generic_ResultSet<Message_ResultSet>> UpdateMessage(Int64 id, string content, string status, string creationDate, string sentDate, string modifiedDate)
        {
            Generic_ResultSet<Message_ResultSet> result = new Generic_ResultSet<Message_ResultSet>();
            try
            {
                ...
                Message = await _message_operations.Update(Message, id);
