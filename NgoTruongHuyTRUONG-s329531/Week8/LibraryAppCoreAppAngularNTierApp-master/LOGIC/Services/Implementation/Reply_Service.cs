...
{
    /// <summary>
    /// This service allows us to Add, Fetch and Update Reply reply Data
    /// </summary>
    public class Reply_Service : IReply_Service
    {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<Generic_ResultSet<List<Reply_ResultSet>>> GetAllReplies()
        {
            Generic_ResultSet<List<Reply_ResultSet>> result = new Generic_ResultSet<List<Reply_ResultSet>>();
            try
            {
                //GET ALL Reply replyES
                List<Reply> Replies = await _reply_operations.ReadAll();
        ...
        /// <returns></returns>
        public async Task<Generic_ResultSet<Reply_ResultSet>> AddReply(string content, string status)
        {
            Generic_ResultSet<Reply_ResultSet> result = new Generic_ResultSet<Reply_ResultSet>();
            try
            {
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        public async Task<Generic_ResultSet<Reply_ResultSet>> UpdateReply(Int64 reply_id, string content, string status)
        {
            Generic_ResultSet<Reply_ResultSet> result = new Generic_ResultSet<Reply_ResultSet>();
            try
            {
