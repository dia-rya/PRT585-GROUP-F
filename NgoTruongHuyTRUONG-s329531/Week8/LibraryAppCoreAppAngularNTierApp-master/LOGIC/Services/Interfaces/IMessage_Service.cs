...
namespace LOGIC.Services.Interfaces
{
    public interface IMessage_Service
    {
        ...
        Task<Generic_ResultSet<Message_ResultSet>> AddMessage(string content, string status, string creationDate, string sentDate, string modifiedDate);
        Task<Generic_ResultSet<Message_ResultSet>> UpdateMessage(Int64 id, string content, string status, string creationDate, string sentDate, string modifiedDate);
