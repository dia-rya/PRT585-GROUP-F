...
namespace LOGIC.Services.Interfaces
{
    ...
    {
        /* fetch methods */
        Task<Generic_ResultSet<List<Reply_ResultSet>>> GetAllReplies();
        ...
        Task<Generic_ResultSet<Reply_ResultSet>> AddReply(string content, string status);
        Task<Generic_ResultSet<Reply_ResultSet>> UpdateReply(Int64 id, string content, string status);
