...
namespace LOGIC.Services.Interfaces
{
    public interface IUser_Service
    {
        ...
        Task<Generic_ResultSet<User_ResultSet>> AddUser(string userName, string password, string profileName, string email, string creationDate);
        Task<Generic_ResultSet<User_ResultSet>> UpdateUser(Int64 id, string userName, string password, string profileName, string email, string creationDate);
