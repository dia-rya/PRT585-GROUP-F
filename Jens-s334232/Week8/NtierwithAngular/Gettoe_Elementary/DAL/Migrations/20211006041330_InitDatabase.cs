        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    applicant_creationdate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 10, 6, 4, 13, 30, 517, DateTimeKind.Utc).AddTicks(1909)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    application_status_creationdate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 10, 6, 4, 13, 30, 535, DateTimeKind.Utc).AddTicks(5897)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    grade_creationdate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 10, 6, 4, 13, 30, 537, DateTimeKind.Utc).AddTicks(4413)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    grade_id = table.Column<long>(type: "bigint", nullable: false),
                    application_status_id = table.Column<long>(type: "bigint", nullable: false),
                    application_creationdate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 10, 6, 4, 13, 30, 538, DateTimeKind.Utc).AddTicks(2287)),
