...
namespace LOGIC.Services.Interfaces
{
    ...
    {
        /* fetch methods */
        Task<Generic_ResultSet<List<EnrolledClass_ResultSet>>> GetAllStudents();
        Task<Generic_ResultSet<EnrolledClass_ResultSet>> GetStudentById(Int64 id);
        ...
        Task<Generic_ResultSet<EnrolledClass_ResultSet>> AddStudent(string name);
        Task<Generic_ResultSet<EnrolledClass_ResultSet>> UpdateStudent(Int64 id, string name);
